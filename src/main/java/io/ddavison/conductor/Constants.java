...
public class Constants {
    ...
    public static final String JVM_CONDUCTOR_CAPABILITIES = "CONDUCTOR_CAPABILITIES";
    ...
    public static final String DEFAULT_PROPERTY_OPTIONS = "options";
    public static final String DEFAULT_PROPERTY_CAPABILITIES = "capabilities";
}
